...
Each individual observer derives the description of his perceptual event by translating it to \todo{XXX}. %TODO
...
This process is shown in Figure~\ref{img:chap02:quality-event} as extension to the perceptual event processing and description process \todo{REF previous section, blauert}.
\begin{figure}
...
\cite{raake_voip_book, raake_book} extended the \emph{quality formation process} of \cite{jekosch_voice_2005}.
Raake's splits the quality formation process into three phases.
The first phase contains the sensory processing depending on contextual information and predescessing perceptual events, which transforms a physical event to a perceptual event.

Figure~\ref{img:chap02:quality-formation-process} 

\begin{figure}
	\includegraphics[width=1\textwidth]{fig/quality-formation-process}
	\caption{Quality-formation process as defined by \cite{raake_book} extending \cite{jekosch_voice_2005}.}
	\label{img:chap02:quality-formation-process}
\end{figure}

With regard to telecommunication systems and services the perceived quality has been extended to \ac{QoE}.
...
%\item Perceptual dimensions [Moeller, Raake]%NOTE: Features only very short!
