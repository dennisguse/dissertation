...
The work of Jekosch with regard to the \emph{quality formation process} was extended by later Raake\cite{raake_voip_book, raake_book}.

\begin{figure}
	\includegraphics[width=1\textwidth]{fig/quality-formation-process}
	\caption{Quality formation process\cite{raake_book}}
