...
Based upon the judgments, a \acf{MOS} can be derived by averaging of all judgments per stimulus \citep{itu-t_recommendation_p.800.2_mean_2013}.
...
Taking momentary judgments might affect the perceptual, quality formation, and descriptive processes, because the assessment task must be conducted in parallel. %TODO REF
