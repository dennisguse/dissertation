...
Already during perception the amount of information is reduced, because only a subset of information can be encoded successfully into the perceptional memory and afterwards into the working memory \citep[][p.\,8f.]{raake_speech_2006}.
...
This memory stores specific information and their spatial\-/temporal relationship \citep[][p.\,385]{tulving_episodic_1972}.
