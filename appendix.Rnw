...
The \textsc{\lowercase{STL2009}} were used for coding \textsc{\lowercase{G.711}} and \textsc{\lowercase{G.722}}~(Mode~1), and inserting packet loss for \textsc{\lowercase{G.722}}~(Mode~1, \ac{PLC mode 0}.
