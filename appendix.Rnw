...
\chapter{Appendix}\label{appendix:setups}
...
\paragraph*{Listening-only Training}
...
\paragraph*{Two-party Speech telephony}
...
\subparagraph*{Network-based Setup}
...
\subparagraph*{Additional Processing}
...
In experiment \E2b the \ac{VoD} service was presented on the display Nexus~7 (2013) showing videos horizontal in full screen.
...
\paragraph*{Speech Telephony Service}
