...
The brightness of this \unit[7]{inch} display was set to maximum without applying any device related color adaptation.
...
\begin{figure}[H]
	...
	<<plotE1, echo=F, fig.height=12>>=
		ggplot_timeseries_create(subset(timeseries, experiment=="E1")) + geom_boxplot(aes(factor(id), y=QU), na.rm=T) + facet_grid(condition ~ .) + xlab("Usage Episode") + theme(panel.margin = unit(1, "lines"))
	@
...
\begin{figure}[H]
	...
	<<plotE2a, echo=F, fig.height=10.5>>=
		ggplot_timeseries_create(subset(timeseries, experiment=="E2a")) + geom_boxplot(aes(factor(id), y=QU), na.rm=T) + facet_grid(condition ~ .) + xlab("Usage Episode") + theme(panel.margin = unit(1, "lines"))
	@
...
\begin{figure}[H]
	...
	<<plotE2b, echo=F, fig.height=7.5>>=
		ggplot_timeseries_create(subset(timeseries, experiment=="E2b" & service != "bundle")) + geom_boxplot(aes(factor(id), y=QU), na.rm=T) + facet_grid(condition + service~ .) + xlab("Usage Episode") + theme(panel.margin = unit(1, "lines"))
	@
...
\begin{figure}[H]
	...
	<<plotE3, echo=F, fig.height=3>>=
		ggplot_timeseries_create(subset(timeseries, experiment=="E3")) + geom_boxplot(aes(factor(id), y=QU), na.rm=T) + facet_grid(condition ~ .) + xlab("Usage Episode") + theme(panel.margin = unit(1, "lines"))
	@
...
\begin{figure}[H]
	...
	<<plotE6, echo=F, fig.height=9>>=
		ggplot_timeseries_create(subset(timeseries, experiment=="E6a")) + geom_boxplot(aes(factor(id), y=QU), na.rm=T) + facet_grid(condition ~ .) + xlab("Usage Episode") + theme(panel.margin = unit(1, "lines"))
	@
