...
For \EIIb{} the videos material was cut with \emph{Adobe Premiere 6} and exported with \ac{H.264} (\unit[1280x720]{px}, \unit[5]{Mbit/s}, two-pass) and \ac{AAC} (\unit[448]{kbit/s}, stereo).
...
In the following, judgments for all experiments are shown.
Here, episodic judgments are presented for all conducted experiments.
...
\begin{figure}[H]
	...
	@
	\caption{One session (\E6{}): box plot of episodic judgments.}
\end{figure}
