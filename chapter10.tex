...
For interactive situations, such as telephone calls, methods have been developed to suggest specific user behavior and thus limit the impact of varying user behavior on the perceived quality.
...
This complements prior work by \citet{duncanson_average_1969}, which allowed free-use of a service, focusing on the average perceived quality of a telephone call.
...
These two adaptations were expected to reduce the impact in terms of unexplainable variance of the required between-subject design, as all participants have a common basis for the assessment of the multi\-/episodic conditions.
...
The multi\-/episodic judgments decrease here until two consecutive degraded episodes/days were presented.
...
Here, a recency effect could be observed for one degraded episode only in case of two-party conversation (\E1{}), whereas it was not observed for third-party listening (\EIIa{}).
...
The large number of conditions in \E1{}, \EIIa{}, and \E6{} enabled to evaluate the accuracy of potential prediction models (\autoref{chap:modeling}).
Here, it was desired to predict the multi\-/episodic \ac{MOS} using on prior episodic judgments in terms of \ac{MOS}.
...
Here, it is not (yet) known if the multi\-/episodic perceived quality is integrated, for example, by device or rather by service.
