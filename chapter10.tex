...
Here, it was desired to predict the multi\-/episodic \ac{MOS} based upon prior episodic \ac{MOS}.
Based upon \citet{moller_single-call_2011}, which applied the average of all prior judgments, the weighted average is applied.
