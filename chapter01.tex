...
\subparagraph*{}
I will conduct this investigation for two \emph{usage periods}.
...
The duration of one session is here chosen to be up to \unit[45]{min} long, because this is a common duration for subjective experiments on perceived quality.
...
Then, the state of the art on perceived quality under performance fluctuations is presented.
