...
\renewcommand{\myVersion}{\Sexpr{system("git rev-parse HEAD", intern=T)}}
...
\renewcommand{\theHsection}{\alph{chapter}.\alph{section}}
\renewcommand{\thesection}{\alph{chapter}.\alph{section}}
\renewcommand{\theHsubsection}{\alph{chapter}.\alph{section}.\alph{subsection}}
\renewcommand{\thesubsection}{\alph{chapter}.\alph{section}.\alph{subsection}}
\pagenumbering{roman}\setcounter{page}{1}
\part*{Appendix}\label{chap:appendix}\cleardoublepage
