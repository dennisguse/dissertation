...
It is assumed that the multi-episodic judgments per service are independent of each other (\autoref{hypo:hypoindependent}).
...
It was expected that presenting this episode with approximately a doubled duration would lead to higher reduction of the multi-episodic judgments than presenting this episode with normal duration (\autoref{hypo:}).
...
In experiment E2b it was assessed, if a 2nd service affects the multi-episodic judgment of the 1st service.
