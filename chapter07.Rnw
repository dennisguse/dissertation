...
A post-hoc test showed a significant difference between condition C4 (\ac{MOS}=$\Sexpr{mos_qu_with_sd_by_condition("E1", "HP", "4")}$) and C7 (\ac{MOS}=$\Sexpr{mos_qu_with_sd_by_condition("E1", "HP", "7")}$) ($p=\Sexpr{wilcox.pairwise.print(QU~condition, "E1", "HP", unique(timeseries[["condition"]]))[["p.value"]][7,4]}$, \Sexpr{wilcox(QU~condition, "E1", "HP", c("4", "7"), c(1:3), diffOnly=T)}).
...
A post-hoc test shows a significant difference between condition C4 and C6 ($p=\Sexpr{wilcox.pairwise.print(QU~condition, "E2a", "HP", unique(timeseries[["condition"]]))[["p.value"]][5,4]}$, \Sexpr{wilcox(QU~condition, "E1", "HP", c("4", "7"), c(1:3), diffOnly=T)}).
...
In experiment E2b the episodic judgments of \ac{HP} episodes for the telephony service are significant different between conditions C5a and C5b (\Sexpr{wilcox(QU~condition, "E2b", "HP", c("5a0", "5a4"))}), but not for \ac{LP} episodes (\Sexpr{wilcox(QU~condition, "E2b", "LP", c("5a0", "5a4"))}).
...
A post-hoc tests for experiment E1 shows that C3 and C5b are significant different (\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("3", "5b", "6"), c("6"))[["p.value"]][1,1]}) as well as C3 and C6 (\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("3", "5b", "6"), c("6"))[["p.value"]][2,1]}), but C5b and C6 are not significant different (\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("3", "5b", "6"), c("6"))[["p.value"]][2,2]}).
A post-hoc tests for experiment E2a shows that C3 and C5a are significant different (\Sexpr{wilcox.pairwise.print(IQU~condition, "E2a", unique(timeseries[["performance_level"]]), c("3", "5a", "6"), c("6"))[["p.value"]][1,1]}) as well as C3 and C6 (\Sexpr{wilcox.pairwise.print(IQU~condition, "E2a", unique(timeseries[["performance_level"]]), c("3", "5a", "6"), c("6"))[["p.value"]][2,1]}), but C5a and C6 are not significant different (\Sexpr{wilcox.pairwise.print(IQU~condition, "E2a", unique(timeseries[["performance_level"]]), c("3", "5a", "6"), c("6"))[["p.value"]][2,2]}).
...
Conditions C4 and C5(a+b) present two consecutive LP episodes with one or no \ac{HP} episode before the multi-episodic judgment.
...
The one-sided post-hoc test shows that C1 is significant different to C2a and C3 (each $p=\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("1", "2a", "3"), c(6), alternative="less")[["p.value"]][1,1]}$, C1 vs. C2a: \Sexpr{wilcox(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("1", "2a"), c(6), alternative="greater", diffOnly=T)}, C1 vs. C3: \Sexpr{wilcox(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("1", "3"), c(6), alternative="greater", diffOnly=T)}), but that C2a and C3 are not significant different ($p=\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("1", "2a", "3"), c(6), alternative="less")[["p.value"]][2,2]}$).
...
This hypothesis can be evaluated by comparing C4 and C5a, for which it has already been shown that those two conditions yield a different result (\cf, \autoref{hypo:position}), with condition C8.
...
A one-sided post-hoc test shows a significant difference between all three performance levels (\ac{HP} vs. \ac{MP}: \Sexpr{wilcox.pairwise.print(QU~condition, "E1", unique(timeseries[["performance_level"]]), c("2a", "5b", "7"), c(6))[["p.value"]][2,1]}, \ac{HP} vs. \ac{LP}: \Sexpr{wilcox.pairwise.print(QU~condition, "E1", unique(timeseries[["performance_level"]]), c("2a", "5b", "7"), c(6))[["p.value"]][1,1]}, \ac{MP} vs. \ac{LP}: \Sexpr{wilcox.pairwise.print(QU~condition, "E1", unique(timeseries[["performance_level"]]), c("2a", "5b", "7"), c(6))[["p.value"]][2,2]}).
...
A one-sided post-hoc shows significant differences for conditions C2a and C5b (\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("2a", "5b", "7"), c(6))[["p.value"]][1,1]}) as well as conditions C5b and C7 (\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("2a", "5b", "7"), c(6))[["p.value"]][2,2]}).
Condition C2a and C7 are not significant different (\Sexpr{wilcox.pairwise.print(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("2a", "5b", "7"), c(6))[["p.value"]][2,1]}).
...
This is in line with prior work on retrospective episodic experiences \citep[e.g.,][]{kahneman_experienced_2000} as well as episodic QoE \citep[e.g.,][]{weiss_modeling_2009}, where it is denoted as (negative) peak effect.
...
A paired post-hoc tests finds significant differences for condition C5b (3rd and 6th: $\Sexpr{wilcox.pairwise.print(QU~id, "E1", unique(timeseries[["performance_level"]]), "5b", c(3, 6, 9), paired=T)[["p.value"]][1,1]}$, 3rd and 9th: $\Sexpr{wilcox.pairwise.print(QU~id, "E1", unique(timeseries[["performance_level"]]), "5b", c(3, 6, 9), paired=T)[["p.value"]][2,1]}$ as well as 3rd and 9th: $\Sexpr{wilcox.pairwise.print(QU~id, "E1", unique(timeseries[["performance_level"]]), "5b", c(3, 6, 9), paired=T)[["p.value"]][2,2]}$).
For condition C7 significant differences are found between the 3rd and 6th judgment ($\Sexpr{wilcox.pairwise.print(QU~id, "E1", unique(timeseries[["performance_level"]]), "5b", c(3, 6, 9), paired=T)[["p.value"]][2,2]}$) as well as the 6th and 9th judgment = ($\Sexpr{wilcox.pairwise.print(QU~id, "E1", unique(timeseries[["performance_level"]]), "5b", c(3, 6, 9), paired=T)[["p.value"]][1,1]}$).
The 3rd and 9th judgment are not significant different ($\Sexpr{wilcox.pairwise.print(QU~id, "E1", unique(timeseries[["performance_level"]]), "5b", c(3, 6, 9), paired=T)[["p.value"]][2,1]}$).
The final multi-episodic judgments of condition C5b and condition C7 are significant different (\Sexpr{wilcox(IQU~condition, "E1", unique(timeseries[["performance_level"]]), c("5b", "7"), c(9), paired=T)}).
