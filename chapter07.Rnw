...
\begin{table}
  \centering
	...
	\hline
	\multirow{2}{*}{\EIIb{}}	& Telephony (Listening)	& \Sexpr{mos_qu_with_sd_by_condition("E2b", "HP", c("5a0", "5a4"))} 	& - 											& \Sexpr{mos_qu_with_sd_by_condition("E2b", "LP", c("5a0", "5a4"))} \\
...
\subsubsection{Experiment \EIIa{} and \EIIb{}}\label{chap:lab:sec:expE2}  %TODO Redo-study
...
In experiment \EIIb{} the episodic judgments of \ac{HP} episodes for the telephony service are significant different between conditions \CVa{} and \CVb{} (\Sexpr{wilcox(QU~condition, "E2b", "HP", c("5a0", "5a4"))}), but not for \ac{LP} episodes (\Sexpr{wilcox(QU~condition, "E2b", "LP", c("5a0", "5a4"))}). %TODO c(1:3)?
...
For experiment \EIIb{} neither the multi-episodic judgments of the telephony service (\Sexpr{wilcox(IQU~condition, "E2b", "HP", c("5a0", "5a4"), c(3))} nor the \ac{VoD} service (\Sexpr{wilcox(IQU~condition, "E2b", "HP", c("0", "4"), c(3))}) are significantly different between the conditions.
...
In \EIIb{} the speech telephony service is always presented in condition C5 whereas the \ac{VoD} is presented either in condition \C0{} or condition \C4{}.
...
However, the multi-episodic judgments of the speech telephony service for condition C5 are significant different between experiment \EIIa{} and experiment \EIIb{} (\Sexpr{wilcox(IQU~experiment, c("E2a", "E2b"), unique(timeseries[["performance_level"]]), c("5a", "5a0", "5a4"), c(6), alternative="less")}). %TODO: "less" is not really nice here :D
...
\centering
 \begin{tabulary}{\columnwidth}{c|C|C|C}
	...
	\hline
	\EIIb{}			& \C0{}					& \Sexpr{mos_iqu_with_sd_by_condition("E2b", "5a0", 6, "telephony")}	& \Sexpr{mos_iqu_with_sd_by_condition("E2b", "0", 6, "video")}\\
	\hline
	\EIIb{}			& \C4{}					& \Sexpr{mos_iqu_with_sd_by_condition("E2b", "5a4", 6, "telephony")}	& \Sexpr{mos_iqu_with_sd_by_condition("E2b", "4", 6, "video")}\\
 \end{tabulary}
