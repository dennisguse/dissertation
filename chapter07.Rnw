...
\autoref{chap:lab}ef{hypo:position} focuses on the position of the \ac{LP} episodes towards the following multi-episodic judgment.
...
For \ac{HP} episodes E1 yielded $\Sexpr{mos_qu_with_sd_by_condition("E2a", "HP", unique(timeseries[["condition"]]), c(1:3))}$ and E2a $\Sexpr{mos_qu_with_sd_by_condition("E2a", "HP", unique(timeseries[["condition"]]))}$.
For \ac{LP} episodes E1 yielded $\Sexpr{mos_qu_with_sd_by_condition("E1", "LP", unique(timeseries[["condition"]]))}$ and E2a $\Sexpr{mos_qu_with_sd_by_condition("E2a", "LP", unique(timeseries[["condition"]]))}$
E1 resulted in lower episodic judgments for both \ac{HP} and \ac{LP} than E2a.
This indicates that the usage situation influences the formation process of episodic \ac{QoE}, although the effect is rather small.
