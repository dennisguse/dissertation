...
Here, the codec \emph{\textsc{\lowercase{G.722}}} (Mode~1)~is selected \citep{itu-t_recommendation_\textsc{\lowercase{G.722}}_7khz_2012}.
...
For \ac{MP}, \emph{\textsc{\lowercase{G.711}}}~\citep{itu-t_recommendation_\textsc{\lowercase{G.711}}_pulse_1988} is selected.
