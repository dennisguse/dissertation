...
In difference to \citet{moller_single-call_2011}, who predicted multi\-/episodic judgments using episodic judgments per individual participant, the goal here is to predict the multi\-/episodic \ac{MOS} based on the episodic \ac{MOS}.
