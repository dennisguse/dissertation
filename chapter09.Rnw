...
However, the actual window is increased by $\mathit{2*w}$, so that the very first usage episode can be considered by this model type, \ie, assigning a maximum weight of 0.5.
...
ggplot_model_create(subset(data_nonadjusted, data_nonadjusted$experiment == "E1" & data_nonadjusted$id == 3), 0.25) + 
 ...
 scale_linetype_manual(values=c("solid", "solid", "solid", "solid", "solid", "solid", "solid", "dotted")) +
