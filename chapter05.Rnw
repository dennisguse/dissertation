...
However, the judgment after the 2nd\,day is not significantly different from the judgment after the 12th\,day, and the judgment after the 7th\,day is not significantly different from the 12th\,day (each \Sexpr{wilcox.pairwise.print(IQU~id, "MOELLER", c("LP", "HP"), "S2", c(4, 14, 24))[2,2]}).
...
However, the multi\-/episodic judgments only provide limited insight, since the differences between conditions are rather small.
...
The work of \citet{duncanson_average_1969} and \citet{moller_single-call_2011} form a basis for the investigation of the formation process of multi\-/episodic quality.
