...
\begin{table}[h]
	...
	\end{tabular}
	\caption[Episodic and multi-episodic judgments by \cite{moller_single-call_2011}.]{Episodic and multi-episodic judgments by \cite{moller_single-call_2011}. Reported as \ac{MOS} with standard deviation in brackets.}
...
The experiment of \cite{moller_single-call_2011} showed that multi-episodic perceived quality can be assessed with defined-use in a field study.
