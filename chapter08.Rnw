...
Here, a reduction of circa 1pt for none to one and one to two days is observed.
...
Thus, \autoref{hypo:consecutive} cannot be answered.
...
The observed difference might also be attributed to a recency effect.
