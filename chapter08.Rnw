...
The goal of \E4{} was the application the defined-use method in a similar usage period and gather practical knowledge about conducting a field experiment.
Besides this, conducting \E4{} had two goals:
...
The multi\-/episodic judgments day-wise between the two conditions does not seem to be different.
...
This experiment is also inspired by the one-session experiments.
