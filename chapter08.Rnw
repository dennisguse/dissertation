...
With regard to multi-episodic \ac{QoE} the gathered data is not sufficient for creation of a prediction model.
...
Details of the technical setup are described in the \appendix{} (see \autoref{appendix:setups}).
