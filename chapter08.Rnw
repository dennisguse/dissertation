...
For the \ac{VoD} service, the video was encoded with H.264 at a resolution of \unit[720$x$576]{px} and the audio channel with \acs{AAC} (\unit[48]{kHz}, \unit[165]{kbit/s}, stereo).
...
Episodic judgments and multi\-/episodic judgments are shown in \autoref{tab:field:e4results}.
