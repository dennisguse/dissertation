...
Based upon the practical insights of \E4{}, in \E5{} only media-consumption was used.\footnote{The results of \E5{} are published in \citet{guse_modelling_2014}.}
...
Comparing the multi\-/episodic judgments day-wise between the two conditions does not show significant differences.
...
In fact, the judgment after the \unit[3rd]{day} is only based upon \ac{HP} episodes.
...
\autoref{hypo:consecutive} must be rejected based upon \E6{}.
...
This is used in the following chapter to develop and evaluate models for the prediction of multi\-/episodic judgments based upon episodic judgments both in terms of \ac{MOS}.
