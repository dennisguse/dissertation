...
21~participants (11~female, 10~male) took part in this experiment with an average of 27.8~years ($\sigma = 4.0$).
...
In fact, the judgment after the 3rd~day is only based on \ac{HP} episodes.
