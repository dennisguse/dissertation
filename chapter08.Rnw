...
Each pair needed to solve two \acp{SCT} per day.%\footnote{For \E4{} all \acp{SCT} defined in ITU-T P.805 \citep{itu-t_p.805:_2007} were used and complement by self-developed but similar \acp{SCT}.}
...
Neither \ac{FECT} nor \ac{PLC} were applied.
...
\centering
 \begin{tabular}{c|c|c||c|c}
	...
	\end{tabular}
	\caption{Multi-episodic judgments of \E5{} by condition and service.}
