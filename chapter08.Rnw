...
6 questionnaires with multi-episodic perceived quality and \ac{NPS} were not filled.
...
In condition \C10 even the presentation of three consecutive days in \ac{HP} only lead to a (non-significant) increase.
