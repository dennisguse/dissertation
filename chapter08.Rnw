...
This enables repeated use of service for rather short episodes while limiting effort for participants.
...
In \E5{} it the adaption speed of multi\-/episodic judgments was planed to be investigated.
...
This experiment indicated only little differences between on multi-episodic judgments between the evaluated multi-episodic conditions (\cf, \autoref{prior:moeller}).
This might be due to the limited number of degraded episodes or that introduced degradations were not severe enough.
The goal of \E4{} was to apply the defined-use method in a similar usage period and gather practical knowledge about conducting a field experiment on the quality formation process.
Besides this \E4{} focused on two aspects.
First, a larger difference of multi\-/episodic judgments between conditions was necessary.
...
The \ac{VoD} service needed to be used daily for one use episode between \unit[1]{pm} and midnight.
...
For the speech telephony service the speech codec G.722 was used for both performance levels with a packet-length of \unit[20]{ms}.
...
Afterwards, a short training was conducted presenting typical degradations with regard to speech telephony and also video transmission.
In addition, one usage episode for both services need to be solved.
...
An analysis of the speech telephony service is omitted here as the implemented setup failed to provide desired performance levels reliably. 
...
In the following, first the episodic judgments are analyzed followed by analyzing multi\-/episodic judgments.
...
\begin{table}
	\centering
	\caption[Multiple days (\E4{}): multi\-/episodic judgments for the \ac{VoD} service.]{Multiple days (\E4{}): multi\-/episodic judgments for the \ac{VoD} service. Reported as \ac{MOS} with standard deviation in brackets.}
...
This system did not provide the desired performance levels.
This technical failure prevented that participants were exposed to the same condition with regard to multi\-/episodic perceived quality and thus a \ac{MOS} evaluation could not be conducted.
The system failed to cope with temporary network limitations.
In addition, some pairs of participants found it very difficult to conduct two calls daily.
Here, it was problematic to find the time slots and embed them into their daily life.
...
With regard to multi\-/episodic \ac{QoE} the gathered data is not sufficient for the creation of a prediction model.

\section{Experiment E5}
Based upon the practical insights of \E4{}, in \E5{} only media-consumption is used.\footnote{The results of \E5{} are published in \citet{guse_modelling_2014}.}
Here, a \ac{VoD} service and an \ac{AoD} service is used.
Similar to \E4{} the services needed to be used over a usage period of \unit[14]{days}.
In this experiment the impact of increasing the number of performance changes between usage episodes on multi\-/episodic judgment is investigated.
...
The audio signal was treated such as the \ac{AoD} service.
The video signal was encoded to the native resolution of the mobile device (\unit[800$x$480]{px}; \unit[4.3]{inch}) at \unit[25]{\acs{FPS}} with H.264 (two-pass).
...
Comparing the multi\-/episodic judgments day-wise between the two conditions does show no significant differences.
...
A reason for this might be that both services presented the audio modality with the same performance levels and thus similar degradations.
...
Here, the audio book Isabel Allende's \emph{"City of the Beats"} has been used as in \E3{} and \E5{}.
...
After each episode two content-related questions were presented to force participants to follow the content.
...
Then, the judgments remain on the same level.
...
However, the slight improvement in the judgment of \C8{} compared to \C5{} can also be explained by a recency effect due to the earlier presentation of the first \ac{LP} episodes.
...
With regard to \autoref{hypo:consecutive} the results of \E6{} lead to the rejection of this hypothesis.
...
This indicates that the episodes have a higher impact on the quality formation process than the actual time between episodes.
...
In difference to \E4{} and \E5{}, \E6{} does provide a large data set (\unit[6]{conditions}, \unit[95]{participants}).
This is used in the following chapter to develop and evaluation models for the prediction of multi\-/episodic judgments based upon episodic judgments.
