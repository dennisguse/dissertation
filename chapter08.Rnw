...
ggplot_timeseries_create(subset(timeseries, experiment=="E4a" & condition=="A1" & service == "VoD" & id != 0)) + geom_boxplot(aes(factor(id), y=QU), na.rm=T) + xlab("Day")
	@
	\caption{Multiple days: Episodic judgments for \E4{} for the \ac{VoD} service in \C9{}.}
...
\begin{table}
	\centering
	\caption{Multiple days: Multi-episodic judgments for the \ac{VoD} service of \E4{}}
...
\begin{figure}[h]
	...
	@
	\caption[Multiple days: Box plot of episodic judgments in \E5{} for \C9{} and \CX{}]{Multiple days: Box plot of episodic judgments in \E5{} for \C9{} (top) and \CX{} (bottom).}
...
\begin{table}[h]
	\centering
	\caption{Multiple days: Multi-episodic judgments of \E5{} by condition and service.}
