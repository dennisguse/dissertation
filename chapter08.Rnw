...
In the second condition both services were presented in \ac{HP} for the first two days followed by two days \ac{LP} and so on, resulting in \unit[8]{days} presented \ac{HP} versus \unit[6]{days} presented in \ac{LP} (denoted as \C9).
...
\begin{figure}
	...
	@
	\caption{Boxplot of episodic judgments for \E4 condition A0.}
...
%	Condition	& \ac{LP} episode(s)	& Day & \ac{VoD} \\
%	\midrule
%	\multirow{4}{*}{\C0}			& \multirow{4}{*}{}	& 4 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A0", 4, "VoD")} \\
%													& 										& 7 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A0", 7, "VoD")} \\
%													& 										& 11 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A0", 11, "VoD")} \\
%													& 										& 14 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A0", 14, "VoD")} \\
% 	\hline
% 	\hline
%	\multirow{4}{*}{\C9}			& \multirow{4}{3, 4, 7, 8, 11, 12}{}	& 4 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A1", 4, "VoD")} \\
%													& 										& 7 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A1", 7, "VoD")} \\
%													& 										& 11 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A1", 11, "VoD")} \\
%													& 										& 14 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A1", 14, "VoD")} \\
%	\end{tabular}
%	\caption{\ac{MOS}  \E4.}
...
\centering
 \begin{tabular}{c|c|c|c}
	...
	11 & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A0", 11, "VoD")} & \Sexpr{mos_iqu_with_sd_by_condition("E4a", "A1", 11, "VoD")} & \Sexpr{wilcox(IQU~condition, "E4a",  c("HP", "LP"), c("A0", "A1"), 11, "VoD", alternative="greater")}\\
