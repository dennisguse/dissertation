...
The first episode is judged with \Sexpr{mos_qu_with_sd_by_condition("E4a", "HP", c("A0", "A1"), c(1), "VoD")}, whereas the last episode reaches \Sexpr{mos_qu_with_sd_by_condition("E4a", "HP", c("A0", "A1"), c(14), "VoD")}.
...
As desired the presentation of \ac{LP} episodes affected the following multi\-/episodic judgment.
...
The conditions are similar to the one-session experiments and are thus denoted with the \emph{same} abbreviations.
