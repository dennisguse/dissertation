...
\citet{hamberg_time-varying_1999} also observed both effects for video sequences of up to a length of \unit[180]{s} while varying impairment duration from \unit[2]{s} to \unit[10]{s}.
