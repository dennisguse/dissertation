...
The \emph{baseline model} for temporal integration is based on the assumption that no temporal effects occur, \ie, that all individual parts of an experience are equally important.
