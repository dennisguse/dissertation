...
\newcommand{\myTitle}{Multi-episodic Subjective Quality of Telecommunication Services\xspace}
...
\PassOptionsToPackage{smaller,printonlyused}{acronym} % Include printonlyused in the first bracket to only show acronyms used in the text
