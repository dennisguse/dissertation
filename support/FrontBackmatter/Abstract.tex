...
% The formation process of this so-called multi-episodic perceived quality is examined for two different time spans. % 
...
% With the empirical data, models for the prediction of multi-episodic judgements are evaluated. %
% These models are based on the weighted average of single episodic judgements, with a linear weighting function outperforming a window function in regard to prediction accuracy and robustness. %
